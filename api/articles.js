...
module.exports = (app) => {
  const save = (req, res) => {
    ...
    try {
      existsOrError(article.name, "Noma não encontrado");
      existsOrError(article.description, "Dscrição não informada");
  ...
  return { save, getSingle, remove, get, getByCategory };
};
